...
export const BackgroundBeams = React.memo(
  ({
    ...
    const reducedPaths = paths.filter((_, index) => index % 4 === 0);
    return (
      <div
        className={cn(
        ...
        >
          ...
          <defs>
            {reducedPaths.map((path, index) => (
              ...
              >
                <stop stopColor={fromColor} stopOpacity="0"></stop>
                <stop stopColor={fromColor}></stop>
                <stop offset="32.5%" stopColor={midColor}></stop>
                <stop offset="100%" stopColor={toColor} stopOpacity="0"></stop>
              </motion.linearGradient>
            ))}
